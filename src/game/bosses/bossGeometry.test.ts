...
it('fills at least a four-by-two grid envelope and keeps symmetric movement bounds', () => {
  ...
  expect(BOSS_GEOMETRY.collisionHalfWidth * 2).toBeGreaterThanOrEqual(grid.cellWidth * 4);
  expect(BOSS_GEOMETRY.collisionHalfHeight * 2).toBeGreaterThanOrEqual(grid.cellHeight * 2);
